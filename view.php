...
//require_once("$CFG->dirroot/mod/moodlels/locallib.php");
//
...
// $url = new moodle_url('/mod/moodlels/view.php', array (
//         'id' => $cm->id,
//         'tab' => $tab,
//         'page' => $page,
//         'perpage' => $perpage,
...
// require_capability('mod/moodlels:view', $context);
// $canmanage = has_capability('mod/moodlels:manage', $context);
//
//
//
// // Log update.
// $simplecertificate = new moodlels($context, $cm, $course);
